...
html {
  ...
  font-family: Inter,Noto Sans,ui-sans-serif,system-ui,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji;
...
h6 {
  color: $default-shade;
  // font-family: "SF Pro Display","SF Pro Icons","Helvetica Neue","Helvetica","Arial",sans-serif, $sans-serif;
  line-height: normal;
}
...
li,
ul {
  padding: 0.1rem 0.2rem 0.2rem 0.7rem;
}
...
.about .text-wrapper .paper-title {
...
.about .text-wrapper .author .author-me {
  color: rgb(66, 101, 165);
  // text-decoration: none;
  font-size: 14px;
}
...
/* Media Query for screens 600 pixels and below */
...
<h2 class="post-section" style="margin-top:70px;margin-bottom:0px;color:rgb(116 144 158)!important;">Citation</h2>
