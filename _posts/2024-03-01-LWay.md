    ...
    <div class="container is-max-desktop">
      <div class="columns is-centered">
        <div class="column has-text-centered">
          <h1 class="title is-2 publication-title">Low-Res Leads the Way</h1>
          <h2 class="title is-3 publication-title">Improving Generalization for Super-Resolution by Self-Supervised Learning</h2>
          <h5 class="is-size-6 publication-authors" style="padding-bottom:10px;">CVPR 2024</h5> 
...
<section class="section" id="BibTeX">
  ...
  title     = {Restore Agent: Autonomous Image Restoration Agent via Multimodal Large Language Models},
  journal   = {arXiv},
  year      = {2024},
}</code></pre>
  </div>
