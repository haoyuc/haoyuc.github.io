...
ground images, optimizing input for the diffusion models.
    ...
    <footer class="bg-white border-t border-gray-200 px-6 py-12">
      ...
      <div class="bg-primary text-white p-6 rounded-lg mt-12 max-w-3xl mx-auto">
        <h3 class="font-['Sailec'] text-xl font-bold mb-4">Citation</h3>
        <pre class="bg-primary/50 p-4 rounded-md overflow-x-auto text-sm">
