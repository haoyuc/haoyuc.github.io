          ...
          <div class="relative">
            ...
            <div class="relative mb-8">
              ...
              <div class="px-12 py-8">
                <p class="font-['Plus Jakarta Sans'] text-3xl text-white/90 leading-relaxed mb-8 max-w-2xl">
                ...
                <button class="group relative inline-flex items-center justify-center !rounded-button bg-transparent border-2 border-white/80 px-8 py-3 overflow-hidden transition-all duration-300 hover:bg-white/10">
