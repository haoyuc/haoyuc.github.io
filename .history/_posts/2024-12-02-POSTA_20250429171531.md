      ...
      <div class="container mx-auto">
        <div class="max-w-4xl mx-auto">
          ...
          <div class="flex justify-center gap-4">
            <a
              href="#"
              class="group relative inline-flex items-center justify-center !rounded-lg bg-primary px-6 py-2 overflow-hidden transition-all duration-300 hover:bg-opacity-90"
            >
              <span
                class="relative font-['Inter'] text-white text-sm flex items-center gap-2"
              >
            ...
            <div class="relative mb-8">
              ...
              <div class="pl-12 pr-12 py-8 flex flex-row items-center">
                <div class="flex-1">
                  ...
                  <a href="https://drive.google.com/drive/folders/1meuQPRwNnlZY5fkis3fouhsPGnXmjXB6?usp=sharing" class="group relative inline-flex items-center justify-center !rounded-button bg-transparent border-2 border-white/80 px-8 py-3 overflow-hidden transition-all duration-300 hover:bg-white/20">
                    <span class="relative font-['Inter'] text-white transition-colors duration-300 flex items-center">
                      <i class="ri-download-line mr-2"></i>Download Dataset (152.3GB)
                    </span>
                  </a>
                </div>
            ...
            <div class="relative mb-8">
              ...
              <div class="pr-12 py-8 flex flex-row items-center">
                <div class="flex-1 pr-8">
                  ...
                  <a href="https://drive.google.com/file/d/15DzZJK5dFnrXky6OZ8grliEPhdvxe4p9/view?usp=drive_link" class="group relative inline-flex items-center justify-center !rounded-button bg-transparent border-2 border-white/80 px-8 py-3 overflow-hidden transition-all duration-300 hover:bg-white/20">
                    <span class="relative font-['Inter'] text-white transition-colors duration-300 flex items-center">
                      <i class="ri-download-line mr-2"></i>Download Dataset (1.66GB) <span class="ml-2 text-xs opacity-70">[Raw Version - Will be Updated]</span>
                    </span>
                  </a>
                </div>
      ...
      <div class="container mx-auto max-w-3xl">
        <div class="text-center">
          ...
          <div class="bg-gray-50 p-6 rounded-lg text-left">
            <pre class="font-['Inter'] text-gray-600 text-sm whitespace-pre-wrap">@misc{chen2025posta,
...
<!-- Default Statcounter code for POSTA
https://haoyuchen.com/POSTA -->
<script type="text/javascript">
var sc_project=13110621; 
var sc_invisible=1; 
var sc_security="23a64fcf"; 
</script>
<script type="text/javascript"
...
class="statcounter"
src="https://c.statcounter.com/13110621/0/23a64fcf/1/"
alt="Web Analytics"
