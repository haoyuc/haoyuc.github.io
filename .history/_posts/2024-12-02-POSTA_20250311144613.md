      ...
      <div class="container mx-auto">
        ...
        <div class="space-y-40">
          ...
          <div class="mt-24 mb-32">
            ...
            <div class="grid grid-cols-7 gap-10" id="artistic-text-gallery">
              <!-- 第一行 -->
              <div class="group relative overflow-visible">
                <img src="./assets/img/POSTA/font/00000.png" class="w-full object-cover transition-all duration-1000 ease-out hover-scale" alt="Artistic Text Example" />
              </div>
              <div class="group relative overflow-visible">
                <img src="./assets/img/POSTA/font/00001.png" class="w-full object-cover transition-all duration-1000 ease-out hover-scale" alt="Artistic Text Example" />
              </div>
              <div class="group relative overflow-visible">
                <img src="./assets/img/POSTA/font/00002.png" class="w-full object-cover transition-all duration-1000 ease-out hover-scale" alt="Artistic Text Example" />
              </div>
              <div class="group relative overflow-visible">
                <img src="./assets/img/POSTA/font/00003.png" class="w-full object-cover transition-all duration-1000 ease-out hover-scale" alt="Artistic Text Example" />
              </div>
              <div class="group relative overflow-visible">
                <img src="./assets/img/POSTA/font/00004.png" class="w-full object-cover transition-all duration-1000 ease-out hover-scale" alt="Artistic Text Example" />
              </div>
              <div class="group relative overflow-visible">
                <img src="./assets/img/POSTA/font/00005.png" class="w-full object-cover transition-all duration-1000 ease-out hover-scale" alt="Artistic Text Example" />
              </div>
              <div class="group relative overflow-visible">
                <img src="./assets/img/POSTA/font/00006.png" class="w-full object-cover transition-all duration-1000 ease-out hover-scale" alt="Artistic Text Example" />
              </div>
              
              <!-- 第二行 -->
              <div class="group relative overflow-visible">
                <img src="./assets/img/POSTA/font/00007.png" class="w-full object-cover transition-all duration-1000 ease-out hover-scale" alt="Artistic Text Example" />
              </div>
              <div class="group relative overflow-visible">
                <img src="./assets/img/POSTA/font/00008.png" class="w-full object-cover transition-all duration-1000 ease-out hover-scale" alt="Artistic Text Example" />
              </div>
              <div class="group relative overflow-visible">
                <img src="./assets/img/POSTA/font/00009.png" class="w-full object-cover transition-all duration-1000 ease-out hover-scale" alt="Artistic Text Example" />
              </div>
              <div class="group relative overflow-visible">
                <img src="./assets/img/POSTA/font/00010.png" class="w-full object-cover transition-all duration-1000 ease-out hover-scale" alt="Artistic Text Example" />
              </div>
              <div class="group relative overflow-visible">
                <img src="./assets/img/POSTA/font/00011.png" class="w-full object-cover transition-all duration-1000 ease-out hover-scale" alt="Artistic Text Example" />
              </div>
              <div class="group relative overflow-visible">
                <img src="./assets/img/POSTA/font/00012.png" class="w-full object-cover transition-all duration-1000 ease-out hover-scale" alt="Artistic Text Example" />
              </div>
              <div class="group relative overflow-visible">
                <img src="./assets/img/POSTA/font/00013.png" class="w-full object-cover transition-all duration-1000 ease-out hover-scale" alt="Artistic Text Example" />
              </div>
              
              <!-- 第三行 -->
              <div class="group relative overflow-visible">
                <img src="./assets/img/POSTA/font/00014.png" class="w-full object-cover transition-all duration-1000 ease-out hover-scale" alt="Artistic Text Example" />
              </div>
              <div class="group relative overflow-visible">
                <img src="./assets/img/POSTA/font/00015.png" class="w-full object-cover transition-all duration-1000 ease-out hover-scale" alt="Artistic Text Example" />
              </div>
              <div class="group relative overflow-visible">
                <img src="./assets/img/POSTA/font/00016.png" class="w-full object-cover transition-all duration-1000 ease-out hover-scale" alt="Artistic Text Example" />
              </div>
              <div class="group relative overflow-visible">
                <img src="./assets/img/POSTA/font/00017.png" class="w-full object-cover transition-all duration-1000 ease-out hover-scale" alt="Artistic Text Example" />
              </div>
              <div class="group relative overflow-visible">
                <img src="./assets/img/POSTA/font/00018.png" class="w-full object-cover transition-all duration-1000 ease-out hover-scale" alt="Artistic Text Example" />
              </div>
              <div class="group relative overflow-visible">
                <img src="./assets/img/POSTA/font/00019.png" class="w-full object-cover transition-all duration-1000 ease-out hover-scale" alt="Artistic Text Example" />
              </div>
              <div class="group relative overflow-visible">
                <img src="./assets/img/POSTA/font/00020.png" class="w-full object-cover transition-all duration-1000 ease-out hover-scale" alt="Artistic Text Example" />
              </div>
              
              <!-- 第四行 -->
              <div class="group relative overflow-visible">
                <img src="./assets/img/POSTA/font/00021.png" class="w-full object-cover transition-all duration-1000 ease-out hover-scale" alt="Artistic Text Example" />
              </div>
              <div class="group relative overflow-visible">
                <img src="./assets/img/POSTA/font/00022.png" class="w-full object-cover transition-all duration-1000 ease-out hover-scale" alt="Artistic Text Example" />
              </div>
              <div class="group relative overflow-visible">
                <img src="./assets/img/POSTA/font/00023.png" class="w-full object-cover transition-all duration-1000 ease-out hover-scale" alt="Artistic Text Example" />
              </div>
              <div class="group relative overflow-visible">
                <img src="./assets/img/POSTA/font/00024.png" class="w-full object-cover transition-all duration-1000 ease-out hover-scale" alt="Artistic Text Example" />
              </div>
              <div class="group relative overflow-visible">
                <img src="./assets/img/POSTA/font/00025.png" class="w-full object-cover transition-all duration-1000 ease-out hover-scale" alt="Artistic Text Example" />
              </div>
              <div class="group relative overflow-visible">
                <img src="./assets/img/POSTA/font/00026.png" class="w-full object-cover transition-all duration-1000 ease-out hover-scale" alt="Artistic Text Example" />
              </div>
              <div class="group relative overflow-visible">
                <img src="./assets/img/POSTA/font/00027.png" class="w-full object-cover transition-all duration-1000 ease-out hover-scale" alt="Artistic Text Example" />
              </div>
            </div>
          </div>
      ...
      document.addEventListener('DOMContentLoaded', function() {
        ...
        gallery.addEventListener('mousemove', function(e) {
          ...
          images.forEach(img => {
            ...
            if (distance < radius) {
              // 距离越近，放大效果越明显
              const scale = 1 + 0.3 * (1 - distance / radius);
