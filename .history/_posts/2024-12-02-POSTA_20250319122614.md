        ...
        <div class="max-w-4xl mx-auto">
          ...
          <div class="flex justify-center gap-4">
            ...
            <a
              ...
              class="tooltip group relative inline-flex items-center justify-center !rounded-lg bg-primary px-6 py-2 overflow-hidden transition-all duration-300 hover:bg-opacity-90"
