      ...
      <div class="container mx-auto">
        <div class="relative mb-48">
          <div class="flex flex-col items-center justify-center">
            <div class="relative">
              <h2
                class="font-['Space_Grotesk'] text-[160px] text-gray-300/20 text-center transition-all duration-1000 ease-out opacity-0 translate-y-12 tracking-tight leading-none"
                id="datasets-bg-text"
              >
                Datasets
              </h2>
            ...
            <div class="mt-8">
              ...
              <div class="w-24 h-1 bg-gradient-to-r from-white/10 via-white/80 to-white/10 mx-auto mt-6"></div>
            </div>
          </div>
        </div>
        <div class="flex flex-col gap-40">
          <div class="relative">
            ...
            <div class="max-w-2xl mx-auto text-center">
              <span class="font-['Inter'] text-6xl font-light text-white/40 inline-block transform -translate-y-4"
                >01</span
              >
              <h4 class="font-['Space_Grotesk'] text-5xl text-white mt-4 mb-8 tracking-tight">
                PosterArt-Design
              </h4>
              <div class="w-16 h-0.5 bg-white/30 mx-auto mb-8"></div>
              <p
                class="font-['Inter'] text-lg text-gray-300 leading-relaxed mb-12 max-w-xl mx-auto"
              >
              ...
              <button
                class="group relative inline-flex items-center justify-center !rounded-button bg-transparent border border-white/30 px-8 py-3 overflow-hidden transition-all duration-300 hover:bg-white/10 backdrop-blur-sm"
              >
                <span
                  class="relative font-['Inter'] text-white/90 group-hover:text-white transition-colors duration-300 flex items-center text-sm tracking-wide"
                >
