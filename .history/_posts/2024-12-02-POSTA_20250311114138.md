      ...
      <div class="container mx-auto">
        ...
        <div class="flex flex-col gap-40">
          <div class="relative">
            ...
            <div class="relative overflow-hidden rounded-xl mb-8" style="width: 100vw; max-width: 100vw; margin-left: calc(-50vw + 50%);">
              <div class="scrolling-wrapper" id="scrolling-wrapper-1" style="display: flex; width: max-content; animation: scroll-left 60s linear infinite;">
                <div class="relative" style="height: 70vh; min-width: 100vw;">
                  <img
                  ...
                  <div class="absolute bottom-0 left-0 w-full p-12 text-white">
                    ...
                    <p class="font-['Plus Jakarta Sans'] text-xl text-gray-300 leading-relaxed mb-12 max-w-2xl">
                    ...
                    <button class="group relative inline-flex items-center justify-center !rounded-button bg-transparent border-2 border-white px-8 py-3 overflow-hidden transition-all duration-300 hover:bg-white">
                      <span class="relative font-['Inter'] text-white group-hover:text-black transition-colors duration-300 flex items-center">
