          ...
          <div class="relative">
            ...
            <div class="flex flex-col gap-12">
              <div class="relative z-10">
                ...
                <ul class="space-y-4 font-['Inter'] text-secondary flex flex-wrap gap-6">
                  <li class="flex items-center gap-3 mb-4 bg-primary/5 px-4 py-3 rounded-lg transition-all duration-300 hover:bg-primary/10">
                    <div
                      class="w-8 h-8 flex items-center justify-center bg-white rounded-full flex-shrink-0 shadow-sm"
                    >
                      <i class="ri-layers-line text-primary text-sm"></i>
                    </div>
                    <span class="font-medium">Layer-based editing</span>
                  </li>
                  <li class="flex items-center gap-3 mb-4 bg-primary/5 px-4 py-3 rounded-lg transition-all duration-300 hover:bg-primary/10">
                    <div
                      class="w-8 h-8 flex items-center justify-center bg-white rounded-full flex-shrink-0 shadow-sm"
                    >
                      <i class="ri-settings-line text-primary text-sm"></i>
                    </div>
                    <span class="font-medium">Fine-tuned controls</span>
                  </li>
                  <li class="flex items-center gap-3 mb-4 bg-primary/5 px-4 py-3 rounded-lg transition-all duration-300 hover:bg-primary/10">
                    <div
                      class="w-8 h-8 flex items-center justify-center bg-white rounded-full flex-shrink-0 shadow-sm"
                    >
                      <i class="ri-edit-line text-primary text-sm"></i>
                    </div>
                    <span class="font-medium">Precise adjustments</span>
                  </li>
                  <li class="flex items-center gap-3 mb-4 bg-primary/5 px-4 py-3 rounded-lg transition-all duration-300 hover:bg-primary/10">
                    <div
                      class="w-8 h-8 flex items-center justify-center bg-white rounded-full flex-shrink-0 shadow-sm"
                    ...
                    <span class="font-medium">Style customization</span>
                  </li>
                </ul>
              </div>
