        ...
        <div class="flex flex-col gap-40">
          <div class="relative">
            ...
            <div class="relative mb-8">
              ...
              <div class="container mx-auto">
                <div class="pl-12 py-8 max-w-2xl" style="position: relative; left: 0;">
                  <div class="flex flex-col gap-8">
                    <p class="font-['Plus Jakarta Sans'] text-3xl text-white/70 leading-relaxed">
                      专业背景与额外的美学布局和排版信息，由专业设计师精心制作。
                    </p>
                    <div class="grid grid-cols-2 gap-8 items-center">
                      <div class="bg-white/5 rounded-lg p-6 backdrop-blur-sm">
                        <div class="flex items-center gap-4 mb-4">
                          ...
                          <h4 class="font-['Space_Grotesk'] text-white text-xl">专业设计</h4>
                        </div>
                        <p class="font-['Inter'] text-white/70">
                          由经验丰富的设计师创建的高质量背景和布局，确保每个海报都具有专业水准。
                        </p>
                      </div>
                      
                      <div class="overflow-hidden rounded-lg">
                        <img 
                          src="./assets/img/POSTA/dataset/design-detail.jpg" 
                          class="w-full h-auto object-cover"
                          alt="PosterArt Design Detail" 
                        />
                      </div>
                    </div>
                    
                    <button class="group relative inline-flex items-center justify-center !rounded-button bg-transparent border-2 border-white/80 px-8 py-3 overflow-hidden transition-all duration-300 hover:bg-white/20 w-fit">
                      <span class="relative font-['Inter'] text-white transition-colors duration-300 flex items-center">
                        <i class="ri-download-line mr-2"></i>下载数据集 (2.3GB)
                      </span>
                    </button>
                  </div>
                </div>
            ...
            <div class="relative mb-8">
              ...
              <div class="container mx-auto">
                <div class="pl-12 py-8 max-w-2xl" style="position: relative; left: 0;">
                  <div class="flex flex-col gap-8">
                    <p class="font-['Plus Jakarta Sans'] text-3xl text-white/70 leading-relaxed">
                      文本元素的分割及相应描述，具有多样化的艺术风格。
                    </p>
                    
                    <div class="grid grid-cols-2 gap-8 items-center">
                      <div class="overflow-hidden rounded-lg">
                        <img 
                          src="./assets/img/POSTA/dataset/text-detail.jpg" 
                          class="w-full h-auto object-cover"
                          alt="PosterArt Text Detail" 
                        />
                      </div>
                      ...
                      <div class="bg-white/5 rounded-lg p-6 backdrop-blur-sm">
                        <div class="flex items-center gap-4 mb-4">
                          <div class="w-10 h-10 flex items-center justify-center bg-white/10 rounded-full">
                            <i class="ri-text-wrap text-white text-xl"></i>
                          </div>
                          <h4 class="font-['Space_Grotesk'] text-white text-xl">艺术文字</h4>
                        </div>
                        <p class="font-['Inter'] text-white/70">
                          精确的文本分割和风格描述，使AI能够生成具有艺术感的文字效果，同时保持完美的可读性。
                        </p>
                      </div>
                    </div>
                    ...
                    <button class="group relative inline-flex items-center justify-center !rounded-button bg-transparent border-2 border-white/80 px-8 py-3 overflow-hidden transition-all duration-300 hover:bg-white/20 w-fit">
                      <span class="relative font-['Inter'] text-white transition-colors duration-300 flex items-center">
                        <i class="ri-download-line mr-2"></i>下载数据集 (1.8GB)
                      </span>
                    </button>
                  </div>
                </div>
          ...
          <div class="relative">
            ...
            <div class="flex flex-col gap-16 items-center">
              <div class="relative w-full">
                ...
                />
                <div class="absolute -bottom-40 -left-40 w-96 h-96 bg-secondary/5 rounded-full blur-[100px]"></div>
              </div>
              <div class="relative z-10 max-w-3xl mx-auto text-center">
                <span class="font-['Inter'] text-6xl font-light text-primary/20 block mb-2">02</span>
                <h3 class="font-['Sailec'] text-4xl text-primary mb-6 font-semibold">
                  Complete Editability
                </h3>
                <p class="font-['Inter'] text-lg text-secondary leading-relaxed mb-8">
                ...
                <div class="grid grid-cols-3 gap-8 mt-12">
                  <div class="bg-primary/5 rounded-xl p-6 text-left transition-all duration-300 hover:shadow-lg">
                    <div class="w-12 h-12 flex items-center justify-center bg-primary/10 rounded-full mb-4">
                      <i class="ri-layers-line text-primary text-xl"></i>
                    </div>
                    <h4 class="font-['Inter'] font-medium text-primary mb-2">Layer-based editing</h4>
                    <p class="font-['Inter'] text-sm text-secondary/80">Manipulate individual elements with precision and control</p>
                  </div>
                  <div class="bg-primary/5 rounded-xl p-6 text-left transition-all duration-300 hover:shadow-lg">
                    <div class="w-12 h-12 flex items-center justify-center bg-primary/10 rounded-full mb-4">
                      <i class="ri-settings-line text-primary text-xl"></i>
                    </div>
                    <h4 class="font-['Inter'] font-medium text-primary mb-2">Fine-tuned controls</h4>
                    <p class="font-['Inter'] text-sm text-secondary/80">Adjust every aspect of your design with detailed settings</p>
                  </div>
                  <div class="bg-primary/5 rounded-xl p-6 text-left transition-all duration-300 hover:shadow-lg">
                    <div class="w-12 h-12 flex items-center justify-center bg-primary/10 rounded-full mb-4">
                      <i class="ri-eye-line text-primary text-xl"></i>
                    </div>
                    <h4 class="font-['Inter'] font-medium text-primary mb-2">Real-time preview</h4>
                    <p class="font-['Inter'] text-sm text-secondary/80">See changes instantly as you make adjustments to your design</p>
                  </div>
                </div>
              </div>
            </div>
