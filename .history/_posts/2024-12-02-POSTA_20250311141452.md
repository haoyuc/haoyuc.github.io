            ...
            <div class="relative mb-8">
              ...
              <div class="pl-12 pr-12 py-8 flex flex-row items-center">
                ...
                <div class="flex-1 pl-8">
                  <img src="./assets/img/POSTA/dataset/design-sample.jpg" class="w-full rounded-lg shadow-xl" alt="PosterArt-Design Sample" />
                </div>
              </div>
            </div>
          </div>
          <div class="relative">
            ...
            <div class="relative mb-8">
              ...
              <div class="pl-12 pr-12 py-8 flex flex-row items-center">
                ...
                <div class="flex-1 pl-8">
                  <img src="./assets/img/POSTA/dataset/text-sample.jpg" class="w-full rounded-lg shadow-xl" alt="PosterArt-Text Sample" />
                </div>
              </div>
            </div>
          </div>
