          ...
          <div class="relative">
            ...
            <div class="relative mb-8">
              ...
              <div class="px-12 py-8">
                <p class="font-['Plus Jakarta Sans'] text-2xl text-gray-700 leading-relaxed mb-8 max-w-2xl">
                ...
                <button class="group relative inline-flex items-center justify-center !rounded-button bg-black border-2 border-black px-8 py-3 overflow-hidden transition-all duration-300 hover:bg-white hover:text-black">
