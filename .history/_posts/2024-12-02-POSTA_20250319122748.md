        ...
        <div class="max-w-4xl mx-auto">
          ...
          <div class="flex justify-center gap-4">
            ...
            <a
              href="#"
              class="group relative inline-flex items-center justify-center !rounded-lg bg-primary px-6 py-2 overflow-hidden transition-all duration-300 hover:bg-opacity-90"
              data-tooltip="We're working on it. Coming soon!"
            >
              <span
                class="relative font-['Inter'] text-white text-sm flex items-center gap-2"
              >
              ...
              <div class="absolute opacity-0 group-hover:opacity-100 bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-1 bg-gray-800 text-white text-xs rounded transition-opacity duration-300 whitespace-nowrap pointer-events-none">We're working on it. Coming soon!</div>
            </a>
            <a
              href="#"
              class="group relative inline-flex items-center justify-center !rounded-lg bg-primary px-6 py-2 overflow-hidden transition-all duration-300 hover:bg-opacity-90"
