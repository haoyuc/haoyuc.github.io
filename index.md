...
<tbody>
  <tr style="padding:0px">
    <td style="width:70%;vertical-align:middle"  class="text-wrapper">
      ...
      <p>
        I received a Bachelor degree in Computer Science and Engineering at The Chinese University of Hong Kong, Shenzhen (CUHKSZ) in 2021. <br>
...
<p> Mainly intrest in computer vision, especially in <strong>Low-level Vision</strong>. </p>
    ...
    <td style="padding:5%;width:30%;max-width:30%;padding-bottom: 5px;" class="image-wrapper">
    
      <a href="../assets/img/profile.jpg"><img style="width:100%;max-width:100%;margin-bottom: 0px;" alt="profile photo" src="../assets/img/profile.jpg" class="hoverZoomLink"></a>
