...
<!-- =================================================================================== -->
  <tr>
    ...
    <td width="75%" valign="center" class="text-wrapper"> 
      ...
      <br>
      Jingjing Ren, Cheng Xu, <strong>Haoyu Chen</strong>, Xinran Qin, Chongyi Li, Lei Zhu
      <br>
...
<!-- =================================================================================== -->
  <tr>
    ...
    <td width="75%" valign="center" class="text-wrapper"> 
      ...
      <br>
      Haoze Sun, Wenbo Li, Jianzhuang Liu, <strong>Haoyu Chen</strong>, Renjing Pei, Xueyi Zou, Youliang Yan, Yujiu Yang
      <br>
      <!-- <em>ACM Multimedia <strong>(ACM MM)</strong></em>, 2023 -->
     <!-- <br> -->
