...
.group:not(:hover) .group-hover\:visible {
    transition-delay: 3s;
}
.group > div {
...
.group:not(:hover) .wechat-tooltip {
...
<body class="bg-white text-gray-900 min-h-screen">
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                <div class="flex items-center">
                    <span class="text-xl font-semibold">Haoyu Chen</span>
                </div>
            ...
            <div class="max-w-4xl mx-auto">
                <div class="flex flex-col md:flex-row gap-16">
                    ...
                    <div class="flex-grow">
                        ...
                        <p class="text-xl text-blue-600 mb-6">PhD student @ HKUST(GZ)</p>
            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div class="space-y-3">
                    <div class="flex items-center space-x-4">
                        <span class="text-gray-500 text-sm font-medium whitespace-nowrap">2025-02</span>
                        <p class="text-gray-700">Two papers to appear in CVPR 2025.</p>
                    </div>
                    <div class="flex items-center space-x-4">
                        <span class="text-gray-500 text-sm font-medium whitespace-nowrap">2024-09</span>
                        <p class="text-gray-700">Two papers to appear in NeurIPS 2024.</p>
                    </div>
                    <div class="flex items-center space-x-4">
                        <span class="text-gray-500 text-sm font-medium whitespace-nowrap">2024-07</span>
                        <p class="text-gray-700">One paper to appear in ECCV 2024.</p>
                    </div>
                    <div class="flex items-center space-x-4">
                        <span class="text-gray-500 text-sm font-medium whitespace-nowrap">2024-02</span>
                        <p class="text-gray-700">Two papers to appear in CVPR 2024.</p>
                    </div>
                    <div class="flex items-center space-x-4">
                        <span class="text-gray-500 text-sm font-medium whitespace-nowrap">2023-07</span>
                    ...
                    <div class="flex items-center space-x-4">
                        <span class="text-gray-500 text-sm font-medium whitespace-nowrap">2023-04</span>
                        <p class="text-gray-700">One paper to appear in ICML 2023.</p>
                    </div>
                    <div class="flex items-center space-x-4">
                        <span class="text-gray-500 text-sm font-medium whitespace-nowrap">2023-02</span>
                        <p class="text-gray-700">One first author paper to appear in CVPR 2023.</p>
                    </div>
                    <div class="flex items-center space-x-4">
                        <span class="text-gray-500 text-sm font-medium whitespace-nowrap">2022-09</span>
            ...
            <div class="max-w-4xl mx-auto">
                    ...
                    <div class="flex items-center space-x-10">
                        ...
                        <div class="flex-grow">
                            <div class="flex items-center justify-between mb-1">
                                <h4 class="font-medium text-lg text-gray-900">The Hong Kong University of Science and Technology (Guangzhou)</h4>
                                <span class="text-gray-500 text-sm bg-gray-100 px-2 py-0.5 rounded">2022 - Present</span>
                            </div>
                            <p class="text-gray-700 text-base mb-0.5">Ph.D. student</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 rounded-2xl px-8 py-5 border border-gray-100">
                    <div class="flex items-center space-x-10">
                        ...
                        <div class="flex-grow">
                            <div class="flex items-center justify-between mb-1">
                                <h4 class="font-medium text-lg text-gray-900">The Chinese University of Hong Kong, Shenzhen</h4>
                                <span class="text-gray-500 text-sm bg-gray-100 px-2 py-0.5 rounded">2017 - 2021</span>
                            </div>
                            <p class="text-gray-700 text-base mb-0.5">B.Eng., Major in Computer Science and Engineering</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="max-w-6xl mx-auto">
                ...
                <div class="mb-16">
                    <div class="sticky top-16 z-10 -mx-8 px-8 py-4 bg-white/80 backdrop-blur-sm border-b border-gray-100">
                        <h3 class="text-xl font-semibold text-gray-900">Generative Models and AIGC</h3>
                    </div>
                    <div class="space-y-6 mt-6 pt-4">
                        ...
                        <div class="flex gap-8 rounded-2xl px-8 py-4 bg-gray-75 first-author-paper">
                            ...
                            <div class="flex-grow">
                                ...
                                <h4 class="font-semibold text-xl text-gray-900 mb-1 leading-snug">POSTA: A Go-to Framework for Customized Artistic Poster Generation</h4>
                                <p class="text-gray-500 text-base mb-2"><span class="author-name">Haoyu Chen</span>*, Xiaojie Xu*, Wenbo Li, Jingjing Ren, Tian Ye, Songhua Liu, Ying-Cong Chen, Lei Zhu, Xinchao Wang</p>
                        ...
                        <div class="flex gap-8 rounded-2xl px-8 py-4">
                            ...
                            <div class="flex-grow">
                                ...
                                <h4 class="font-semibold text-xl text-gray-900 mb-1 leading-snug">UltraPixel: Advancing Ultra-High-Resolution Image Synthesis to New Peaks</h4>
                                <p class="text-gray-500 text-base mb-2">Jingjing Ren*, Wenbo Li*, <span class="author-name">Haoyu Chen</span>, Renjing Pei, Bin Shao, Yong Guo, Long Peng, Lei Zhu</p>
                                <div class="flex gap-3">
                        ...
                        <div class="flex gap-8 rounded-2xl px-8 py-4">
                            ...
                            <div class="flex-grow">
                                ...
                                <h4 class="font-semibold text-xl text-gray-900 mb-1 leading-snug">Towards Flexible, Scalable, and Adaptive Multi-Modal Conditioned Face Synthesis</h4>
                                <p class="text-gray-500 text-base mb-2">Jingjing Ren, Cheng Xu, <span class="author-name">Haoyu Chen</span>, Xinran Qin, Chongyi Li, Lei Zhu</p>
                                <div class="flex gap-3">
                ...
                <div class="mb-16">
                    <div class="sticky top-16 z-10 -mx-8 px-8 py-4 bg-white/80 backdrop-blur-sm border-b border-gray-100">
                        <h3 class="text-xl font-semibold text-gray-900">Multi-Modal Models and Agents</h3>
                    </div>
                    <div class="space-y-6 mt-6 pt-4">
                        <!-- RestoreAgent -->
                        <div class="flex gap-8 rounded-2xl px-8 py-4 bg-gray-75 first-author-paper">
                            ...
                            <div class="flex-grow">
                                ...
                                <h4 class="font-semibold text-xl text-gray-900 mb-1 leading-snug">RestoreAgent: Autonomous Image Restoration Agent via Multimodal Large Language Models</h4>
                                <p class="text-gray-500 text-base mb-2"><span class="author-name">Haoyu Chen</span>, Wenbo Li, Jinjin Gu, Jingjing Ren, Sixiang Chen, Tian Ye, Renjing Pei, Kaiwen Zhou, Fenglong Song, Lei Zhu</p>
                                <div class="flex gap-3">
                        ...
                        <div class="flex gap-8 rounded-2xl px-8 py-4 bg-gray-75 first-author-paper">
                            ...
                            <div class="flex-grow">
                                ...
                                <h4 class="font-semibold text-xl text-gray-900 mb-1 leading-snug">JarvisIR: Elevating Autonomous Driving Perception with Intelligent Image Restoration</h4>
                                <p class="text-gray-500 text-base mb-2">Yunlong Lin*, Zixu Lin*, <span class="author-name">Haoyu Chen</span>*, Panwang Pan*, Chenxin Li, Sixiang Chen, Kairun Wen, Yeying Jin, Wenbo Li, Xinghao Ding</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-16">
                    <div class="sticky top-16 z-10 -mx-8 px-8 py-4 bg-white/80 backdrop-blur-sm border-b border-gray-100">
                        <h3 class="text-xl font-semibold text-gray-900">Generalizable Image Restoration</h3>
                    </div>
                    <div class="space-y-6 mt-6 pt-4">
                        <!-- LWay -->
                        <div class="flex gap-8 rounded-2xl px-8 py-4 bg-gray-75 first-author-paper">
                            ...
                            <div class="flex-grow">
                                ...
                                <h4 class="font-semibold text-xl text-gray-900 mb-1 leading-snug">Low-Res Leads the Way: Improving Generalization for Super-Resolution by Self-Supervised Learning</h4>
                                <p class="text-gray-500 text-base mb-2"><span class="author-name">Haoyu Chen</span>, Wenbo Li, Jinjin Gu, Jingjing Ren, Haoze Sun, Xueyi Zou, Youliang Yan, Zhensong Zhang, Lei Zhu</p>
                                <div class="flex gap-3">
                        ...
                        <div class="flex gap-8 rounded-2xl px-8 py-4 bg-gray-75 first-author-paper">
                            ...
                            <div class="flex-grow">
                                ...
                                <h4 class="font-semibold text-xl text-gray-900 mb-1 leading-snug">Masked Image Training for Generalizable Deep Image Denoising</h4>
                                <p class="text-gray-500 text-base mb-2"><span class="author-name">Haoyu Chen</span>*, Jinjin Gu*, Yihao Liu, Salma Abdel Magid, Chao Dong, Qiong Wang, Hanspeter Pfister, Lei Zhu</p>
                                <div class="flex gap-3">
                        ...
                        <div class="flex gap-8 rounded-2xl px-8 py-4">
                            ...
                            <div class="flex-grow">
                                ...
                                <h4 class="font-semibold text-xl text-gray-900 mb-1 leading-snug">CoSeR: Bridging Image and Language for Cognitive Super-Resolution</h4>
                                <p class="text-gray-500 text-base mb-2">Haoze Sun, Wenbo Li, Jianzhuang Liu, <span class="author-name">Haoyu Chen</span>, Renjing Pei, Xueyi Zou, Youliang Yan, Yujiu Yang</p>
                                <div class="flex gap-3">
                        ...
                        <div class="flex gap-8 rounded-2xl px-8 py-4">
                            ...
                            <div class="flex-grow">
                                ...
                                <h4 class="font-semibold text-xl text-gray-900 mb-1 leading-snug">Crafting Training Degradation Distribution for the Accuracy-Generalization Trade-off in Real-World Super-Resolution</h4>
                                <p class="text-gray-500 text-base mb-2">Ruofan Zhang, Jinjin Gu, <span class="author-name">Haoyu Chen</span>, Chao Dong, Yulun Zhang, Wenming Yang</p>
                                <div class="flex gap-3">
                        ...
                        <div class="flex gap-8 rounded-2xl px-8 py-4 bg-gray-75 first-author-paper">
                            ...
                            <div class="flex-grow">
                                ...
                                <h4 class="font-semibold text-xl text-gray-900 mb-1 leading-snug">Attention in Attention Network for Image Super-Resolution</h4>
                                <p class="text-gray-500 text-base mb-2"><span class="author-name">Haoyu Chen</span>, Jinjin Gu, Zhi Zhang</p>
                                <div class="flex gap-3">
                        ...
                        <div class="flex gap-8 rounded-2xl px-8 py-4">
                            <div class="flex-shrink-0 w-64 flex items-center">
                                <img src="./assets/img/PIPAL.jpg" alt="PIPAL" class="w-full rounded">
                            </div>
                            <div class="flex-grow">
                                <div class="flex items-center justify-between mb-1">
                                    <p class="text-gray-500 text-sm font-medium tracking-wide uppercase">ECCV 2020</p>
                                </div>
                                <h4 class="font-semibold text-xl text-gray-900 mb-1 leading-snug">PIPAL: a Large-Scale Image Quality Assessment Dataset for Perceptual Image Restoration</h4>
                                <p class="text-gray-500 text-base mb-2">Jinjin Gu, Haoming Cai, <span class="author-name">Haoyu Chen</span>, Xiaoxin Ye, Jimmy S.Ren, Chao Dong</p>
                                <div class="flex gap-3">
                ...
                <div class="mb-16">
                    <div class="sticky top-16 z-10 -mx-8 px-8 py-4 bg-white/80 backdrop-blur-sm border-b border-gray-100">
                        <h3 class="text-xl font-semibold text-gray-900">Adverse Weather Restoration</h3>
                    </div>
                    <div class="space-y-6 mt-6 pt-4">
                        <!-- Snow Removal -->
                        <div class="flex gap-8 rounded-2xl px-8 py-4 bg-gray-75 first-author-paper">
                            ...
                            <div class="flex-grow">
                                ...
                                <h4 class="font-semibold text-xl text-gray-900 mb-1 leading-snug">Snow Removal in Video: A New Dataset and A Novel Method</h4>
                                <p class="text-gray-500 text-base mb-2"><span class="author-name">Haoyu Chen</span>, Jingjing Ren, Jinjin Gu, Hongtao Wu, Xuequan Lu, Haoming Cai, Lei Zhu</p>
                                <div class="flex gap-3">
                        ...
                        <div class="flex gap-8 rounded-2xl px-8 py-4">
                            ...
                            <div class="flex-grow">
                                <div class="flex items-center justify-between mb-1">
                                    <p class="text-gray-500 text-sm font-medium tracking-wide uppercase">IJCV 2024</p>
                                </div>
                                <h4 class="font-semibold text-xl text-gray-900 mb-1 leading-snug">Triplane-Smoothed Video Dehazing with CLIP-Enhanced Generalization</h4>
                                <p class="text-gray-500 text-base mb-2">Jingjing Ren, <span class="author-name">Haoyu Chen</span>, Tian Ye, Hongtao Wu, Lei Zhu</p>
                                <div class="flex gap-3">
                        ...
                        <div class="flex gap-8 rounded-2xl px-8 py-4">
                            ...
                            <div class="flex-grow">
                                ...
                                <h4 class="font-semibold text-xl text-gray-900 mb-1 leading-snug">Semi-Supervised Video Desnowing Network via Temporal Decoupling Experts and Distribution-Driven Contrastive Regularization</h4>
                                <p class="text-gray-500 text-base mb-2">Hongtao Wu, Yijun Yang, Angelica Aviles-Rivero, Jingjing Ren, Sixiang Chen, <span class="author-name">Haoyu Chen</span>, Lei Zhu</p>
                            </div>
                        </div>
                        ...
                        <div class="flex gap-8 rounded-2xl px-8 py-4">
                            <div class="flex-shrink-0 w-64 flex items-center">
                                <img src="./assets/img/mm1.jpg" alt="Mask-Guided Progressive Network" class="w-full rounded">
                            </div>
                            <div class="flex-grow">
                                <div class="flex items-center justify-between mb-1">
                                    <p class="text-gray-500 text-sm font-medium tracking-wide uppercase">ACM MM 2023</p>
                                </div>
                                <h4 class="font-semibold text-xl text-gray-900 mb-1 leading-snug">Mask-Guided Progressive Network for Joint Raindrop and Rain Streak Removal in Videos</h4>
                                <p class="text-gray-500 text-base mb-2">Hongtao Wu, Yijun Yang, <span class="author-name">Haoyu Chen</span>, Jingjing Ren, Lei Zhu</p>
                                <div class="flex gap-3">
                        ...
                        <div class="flex gap-8 rounded-2xl px-8 py-4">
                            ...
                            <div class="flex-grow">
                                ...
                                <h4 class="font-semibold text-xl text-gray-900 mb-1 leading-snug">Uncertainty-Driven Dynamic Degradation Perceiving and Background Modeling for Efficient Single Image Desnowing</h4>
                                <p class="text-gray-500 text-base mb-2">Sixiang Chen*, Tian Ye*, Chenghao Xue, <span class="author-name">Haoyu Chen</span>, Yun Liu, Erkang Chen, Lei Zhu</p>
                                <div class="flex gap-3">
                        ...
                        <div class="flex gap-8 rounded-2xl px-8 py-4">
                            ...
                            <div class="flex-grow">
                                ...
                                <h4 class="font-semibold text-xl text-gray-900 mb-1 leading-snug">Cross-scale Prototype Learning Transformer for Image Snow Removal</h4>
                                <p class="text-gray-500 text-base mb-2">Sixiang Chen*, Tian Ye*, Yun Liu, Jinbin Bai, <span class="author-name">Haoyu Chen</span>, Yunlong Lin, Jun Shi, Erkang Chen</p>
                                <div class="flex gap-3">
                ...
                <div class="mb-16">
                    <div class="sticky top-16 z-10 -mx-8 px-8 py-4 bg-white/80 backdrop-blur-sm border-b border-gray-100">
                        <h3 class="text-xl font-semibold text-gray-900">Other</h3>
                    </div>
                    <div class="space-y-6 mt-6 pt-4">
                        <!-- SRP -->
                        <div class="flex gap-8 rounded-2xl px-8 py-4 bg-gray-75 first-author-paper">
                            ...
                            <div class="flex-grow">
                                ...
                                <h4 class="font-semibold text-xl text-gray-900 mb-1 leading-snug">Super-resolution perception for industrial sensor data</h4>
                                <p class="text-gray-500 text-base mb-2">Jinjin Gu, <span class="author-name">Haoyu Chen</span>, Guolong Liu, Gaoqi Liang, Xinlei Wang, Junhua Zhao</p>
                                <div class="flex gap-3">
            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div class="bg-gray-50 rounded-2xl px-8 py-5 mb-6 border border-gray-100">
                    <div class="flex items-center space-x-10">
                        ...
                        <div class="flex-grow">
                            <div class="flex items-center justify-between mb-1">
                                <h4 class="font-medium text-lg text-gray-900">Xiaobing.AI</h4>
                                <span class="text-gray-500 text-sm bg-gray-150 px-2 py-0.5 rounded">2021.6 - 2022.2</span>
                            </div>
                            <p class="text-gray-700 text-base mb-0.5">Research Intern</p>
                ...
                <div class="bg-gray-50 rounded-2xl px-8 py-5 border border-gray-100">
                    <div class="flex items-center space-x-10">
                        ...
                        <div class="flex-grow">
                            <div class="flex items-center justify-between mb-1">
                                <h4 class="font-medium text-lg text-gray-900">Amazon Web Services Shanghai AI Lab</h4>
                                <span class="text-gray-500 text-sm bg-gray-150 px-2 py-0.5 rounded">2020.5 - 2020.11</span>
                            </div>
                            <p class="text-gray-700 text-base mb-0.5">Software Develop Engineer Intern</p>
    ...
    <!-- Academic Service & Awards Section -->
    <section id="academic-service" class="py-12 bg-white">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-4xl mx-auto">
                ...
                <!-- Competition Awards -->
                <div class="mb-8">
                    <h3 class="text-xl font-semibold mb-6 text-gray-900">Competition Awards</h3>
                ...
                <div>
                    <h3 class="text-xl font-semibold mb-6 text-gray-900">Program Committee / Reviewer</h3>
                    <div class="bg-gray-50 rounded-lg px-8 py-5 border border-gray-100">
                        <!-- Conferences -->
                        <div class="mb-6">
                ...
                <div class="grid grid-cols-5 gap-6">
                    ...
                    <div class="bg-gray-50 rounded-lg px-6 py-4 border border-gray-100">
                        <div class="flex flex-col items-center">
                            ...
                            <h3 class="text-lg font-medium text-gray-900">Tennis</h3>
                        </div>
                    </div>
                    <!-- Diving -->
                    <div class="bg-gray-50 rounded-lg px-6 py-4 border border-gray-100">
                        <div class="flex flex-col items-center">
                            <span class="text-3xl mb-2">🤿</span>
                            <h3 class="text-lg font-medium text-gray-900">Diving</h3>
                        </div>
                    </div>
                    <!-- Photography -->
                    <div class="bg-gray-50 rounded-lg px-6 py-4 border border-gray-100">
                        <div class="flex flex-col items-center">
                            <span class="text-3xl mb-2">📸</span>
                            <h3 class="text-lg font-medium text-gray-900">Photography</h3>
                        </div>
                    </div>
                    <!-- Outdoor -->
                    <div class="bg-gray-50 rounded-lg px-6 py-4 border border-gray-100">
                        <div class="flex flex-col items-center">
                            ...
                            <h3 class="text-lg font-medium text-gray-900">Outdoor</h3>
                        </div>
                    </div>
                    <!-- Trail Running -->
                    <div class="bg-gray-50 rounded-lg px-6 py-4 border border-gray-100">
                        <div class="flex flex-col items-center">
                            <span class="text-3xl mb-2">🏃</span>
                            <h3 class="text-lg font-medium text-gray-900">Trail Running</h3>
                        </div>
                    </div>
                </div>
